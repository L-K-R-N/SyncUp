...
* https://wowjs.uk
* Copyright (c) 2016 Thomas Grainger; Licensed MIT */})),function(a,b){if("function"==typeof define&&define.amd)define(["module","exports"],b);else if("undefined"!=typeof exports)b(module,exports);else{var c={exports:{}};b(c,c.exports),a.WOW=c.exports}}(this,(function(a,b){"use strict";function c(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function")}function d(a,b){return b.indexOf(a)>=0}function i(a,b,c){null!=a.addEventListener?a.addEventListener(b,c,!1):null!=a.attachEvent?a.attachEvent("on"+b,c):a[b]=c}function j(a,b,c){null!=a.removeEventListener?a.removeEventListener(b,c,!1):null!=a.detachEvent?a.detachEvent("on"+b,c):delete a[b]}Object.defineProperty(b,"__esModule",{value:!0});var l,m,n=function(){function a(a,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1,d.configurable=!0,"value"in d&&(d.writable=!0),Object.defineProperty(a,d.key,d)}}return function(b,c,d){return c&&a(b.prototype,c),d&&a(b,d),b}}(),o=window.WeakMap||window.MozWeakMap||function(){function a(){c(this,a),this.keys=[],this.values=[]}return n(a,[{key:"get",value:function(a){for(var b=0;b<this.keys.length;b++){if(this.keys[b]===a)return this.values[b]}}},{key:"set",value:function(a,b){for(var c=0;c<this.keys.length;c++){if(this.keys[c]===a)return this.values[c]=b,this}return this.keys.push(a),this.values.push(b),this}}]),a}(),p=window.MutationObserver||window.WebkitMutationObserver||window.MozMutationObserver||(m=l=function(){function a(){c(this,a),"undefined"!=typeof console&&console}return n(a,[{key:"observe",value:function(){}}]),a}(),l.notSupported=!0,m),q=window.getComputedStyle||function(a){var b=/(\-([a-z]){1})/g;return{getPropertyValue:function(c){"float"===c&&(c="styleFloat"),b.test(c)&&c.replace(b,(function(a,b){return b.toUpperCase()}));var d=a.currentStyle;return(null!=d?d[c]:void 0)||null}}},r=function(){function a(){var b=arguments.length<=0||void 0===arguments[0]?{}:arguments[0];c(this,a),this.defaults={boxClass:"wow",animateClass:"animated",offset:0,mobile:!0,live:!0,callback:null,scrollContainer:null,resetAnimation:!0},this.animate="requestAnimationFrame"in window?function(a){return window.requestAnimationFrame(a)}:function(a){return a()},this.vendors=["moz","webkit"],this.start=this.start.bind(this),this.resetAnimation=this.resetAnimation.bind(this),this.scrollHandler=this.scrollHandler.bind(this),this.scrollCallback=this.scrollCallback.bind(this),this.scrolled=!0,this.config=function(a,b){for(var c in b)if(null==a[c]){var d=b[c];a[c]=d}return a}(b,this.defaults),null!=b.scrollContainer&&(this.config.scrollContainer=document.querySelector(b.scrollContainer)),this.animationNameCache=new o,this.wowEvent=function(a){var b=!(arguments.length<=1||void 0===arguments[1])&&arguments[1],c=!(arguments.length<=2||void 0===arguments[2])&&arguments[2],d=arguments.length<=3||void 0===arguments[3]?null:arguments[3],e=void 0;return null!=document.createEvent?(e=document.createEvent("CustomEvent")).initCustomEvent(a,b,c,d):null!=document.createEventObject?(e=document.createEventObject()).eventType=a:e.eventName=a,e}(this.config.boxClass)}return n(a,[{key:"init",value:function(){this.element=window.document.documentElement,d(document.readyState,["interactive","complete"])?this.start():i(document,"DOMContentLoaded",this.start),this.finished=[]}},{key:"start",value:function(){var a=this;if(this.stopped=!1,this.boxes=[].slice.call(this.element.querySelectorAll("."+this.config.boxClass)),this.all=this.boxes.slice(0),this.boxes.length)if(this.disabled())this.resetStyle();else for(var b=0;b<this.boxes.length;b++){var c=this.boxes[b];this.applyStyle(c,!0)}if(this.disabled()||(i(this.config.scrollContainer||window,"scroll",this.scrollHandler),i(window,"resize",this.scrollHandler),this.interval=setInterval(this.scrollCallback,50)),this.config.live){var d=new p((function(b){for(var c=0;c<b.length;c++)for(var d=b[c],e=0;e<d.addedNodes.length;e++){var f=d.addedNodes[e];a.doSync(f)}}));d.observe(document.body,{childList:!0,subtree:!0})}}},{key:"stop",value:function(){this.stopped=!0,j(this.config.scrollContainer||window,"scroll",this.scrollHandler),j(window,"resize",this.scrollHandler),null!=this.interval&&clearInterval(this.interval)}},{key:"sync",value:function(){p.notSupported&&this.doSync(this.element)}},{key:"doSync",value:function(a){if(null!=a||(a=this.element),1===a.nodeType)for(var b=(a=a.parentNode||a).querySelectorAll("."+this.config.boxClass),c=0;c<b.length;c++){var e=b[c];d(e,this.all)||(this.boxes.push(e),this.all.push(e),this.stopped||this.disabled()?this.resetStyle():this.applyStyle(e,!0),this.scrolled=!0)}}},{key:"show",value:function(a){return this.applyStyle(a),a.className=a.className+" "+this.config.animateClass,null!=this.config.callback&&this.config.callback(a),function(a,b){null!=a.dispatchEvent?a.dispatchEvent(b):b in(null!=a)?a[b]():"on"+b in(null!=a)&&a["on"+b]()}(a,this.wowEvent),this.config.resetAnimation&&(i(a,"animationend",this.resetAnimation),i(a,"oanimationend",this.resetAnimation),i(a,"webkitAnimationEnd",this.resetAnimation),i(a,"MSAnimationEnd",this.resetAnimation)),a}},{key:"applyStyle",value:function(a,b){var c=this,d=a.getAttribute("data-wow-duration"),e=a.getAttribute("data-wow-delay"),f=a.getAttribute("data-wow-iteration");return this.animate((function(){return c.customStyle(a,b,d,e,f)}))}},{key:"resetStyle",value:function(){for(var a=0;a<this.boxes.length;a++){this.boxes[a].style.visibility="visible"}}},{key:"resetAnimation",value:function(a){if(a.type.toLowerCase().indexOf("animationend")>=0){var b=a.target||a.srcElement;b.className=b.className.replace(this.config.animateClass,"").trim()}}},{key:"customStyle",value:function(a,b,c,d,e){return b&&this.cacheAnimationName(a),a.style.visibility=b?"hidden":"visible",c&&this.vendorSet(a.style,{animationDuration:c}),d&&this.vendorSet(a.style,{animationDelay:d}),e&&this.vendorSet(a.style,{animationIterationCount:e}),this.vendorSet(a.style,{animationName:b?"none":this.cachedAnimationName(a)}),a}},{key:"vendorSet",value:function(a,b){for(var c in b)if(b.hasOwnProperty(c)){var d=b[c];a[""+c]=d;for(var e=0;e<this.vendors.length;e++){a[""+this.vendors[e]+c.charAt(0).toUpperCase()+c.substr(1)]=d}}}},{key:"vendorCSS",value:function(a,b){for(var c=q(a),d=c.getPropertyCSSValue(b),e=0;e<this.vendors.length;e++){var f=this.vendors[e];d=d||c.getPropertyCSSValue("-"+f+"-"+b)}return d}},{key:"animationName",value:function(a){var b=void 0;try{b=this.vendorCSS(a,"animation-name").cssText}catch(c){b=q(a).getPropertyValue("animation-name")}return"none"===b?"":b}},{key:"cacheAnimationName",value:function(a){return this.animationNameCache.set(a,this.animationName(a))}},{key:"cachedAnimationName",value:function(a){return this.animationNameCache.get(a)}},{key:"scrollHandler",value:function(){this.scrolled=!0}},{key:"scrollCallback",value:function(){if(this.scrolled){this.scrolled=!1;for(var a=[],b=0;b<this.boxes.length;b++){var c=this.boxes[b];if(c){if(this.isVisible(c)){this.show(c);continue}a.push(c)}}this.boxes=a,this.boxes.length||this.config.live||this.stop()}}},{key:"offsetTop",value:function(a){for(;void 0===a.offsetTop;)a=a.parentNode;for(var b=a.offsetTop;a.offsetParent;)b+=(a=a.offsetParent).offsetTop;return b}},{key:"isVisible",value:function(a){var b=a.getAttribute("data-wow-offset")||this.config.offset,c=this.config.scrollContainer&&this.config.scrollContainer.scrollTop||window.pageYOffset,d=c+Math.min(this.element.clientHeight,"innerHeight"in window?window.innerHeight:document.documentElement.clientHeight)-b,e=this.offsetTop(a),f=e+a.clientHeight;return d>=e&&f>=c}},{key:"disabled",value:function(){return!this.config.mobile&&function(a){return/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(a)}(navigator.userAgent)}}]),a}();b.default=r,a.exports=b.default})),new WOW({mobile:!1}).init(),document.querySelector(".custom-select-field")){for(const dropdown of document.querySelectorAll(".custom-select-field"))dropdown.addEventListener("click",(function(){this.closest("[data-select]").classList.toggle("open")}));for(const option of document.querySelectorAll(".custom-select-options ul > li"))option.addEventListener("click",(function(){if(!this.classList.contains("selected")){let select=this.closest("[data-select]"),selectInput=select.querySelector("input[type=hidden]"),selected=this.getAttribute("data-value");this.parentNode.querySelector("li.selected").classList.remove("selected"),this.classList.add("selected"),select.querySelector(".custom-select-field div").textContent=this.textContent,select.setAttribute("data-select",selected),selectInput.value=selected,select.classList.remove("open")}}));window.addEventListener("click",(function(e){for(const select of document.querySelectorAll("[data-select]"))select.classList.remove("error"),select.contains(e.target)||select.classList.remove("open")}))}const tabPlugin=header=>{header.addEventListener("click",(e=>{const target=e.target.closest(".prices-tabs__container-title");if(target)for(let elem of document.querySelectorAll("[data-tab]"))elem.classList.remove("active-tab"),elem.getAttribute("data-tab")===target.getAttribute("data-tab")&&(elem.classList.add("active-tab"),target.classList.add("active-tab"))}))};tabPlugin(document.querySelector(".prices-tabs__header"));const accordion=cards=>{cards.addEventListener("click",(e=>{const target=e.target.closest(".questions__card-header");if(!target)return;const targetContent=document.getElementById(target.dataset.accordion);if(targetContent.classList.contains("active-accordion"))targetContent.classList.remove("active-accordion"),target.classList.remove("active-accordion"),targetContent.style.height=0;else{for(let answer of document.querySelectorAll(".questions__card-answer"))answer.classList.remove("active-accordion"),answer.style.height=0;for(let header of document.querySelectorAll(".questions__card-header"))header.classList.remove("active-accordion");targetContent.classList.add("active-accordion"),target.classList.add("active-accordion"),targetContent.style.height=targetContent.scrollHeight+"px"}}))};accordion(document.querySelector(".questions__cards"));const changeHeaderBg=header=>{document.addEventListener("scroll",(()=>{window.scrollY>0?header.classList.add("fixed"):header.classList.remove("fixed")}))};changeHeaderBg(document.querySelector(".header"));const toggleMenu=()=>{const menu=document.querySelector(".header-menu"),burger=(document.querySelector(".header-menu__list"),document.querySelector(".header-burger"));document.querySelector(".header-burger").addEventListener("click",(e=>{menu.classList.toggle("show"),burger.classList.toggle("show"),document.body.classList.toggle("no-scroll")})),document.querySelector(".header-menu__list").addEventListener("click",(e=>{e.target.classList.contains("header-menu__list")&&(menu.classList.remove("show"),burger.classList.remove("show"),document.body.classList.remove("no-scroll")),e.target.closest(".header-menu__list__link")&&(menu.classList.remove("show"),burger.classList.remove("show"),document.body.classList.remove("no-scroll"))}))};toggleMenu();const mouseParallax=(container,elements)=>{container.addEventListener("mousemove",(e=>{let clientX=e.clientX,clientY=e.clientY;const containerLeft=container.getBoundingClientRect().left,containerTop=container.getBoundingClientRect().top,coordX=clientX-containerLeft-container.offsetWidth/2,coordY=clientY-containerTop-container.offsetHeight/2;for(let elem of elements){const speed=elem.dataset.mousespeed,x=-(coordX*speed).toFixed(2),y=-(coordY*speed).toFixed(2);elem.setAttribute("style",`transform: translate(${x}px, ${y}px)`)}}))},scrollParallax=()=>{document.addEventListener("scroll",(()=>{for(let elem of document.querySelectorAll(".scrollParallax")){const speed=elem.dataset.scrollspeed||5;elem.setAttribute("style",`transform: translateY(${window.scrollY/speed}px)`)}}))};document.addEventListener("scroll",(()=>{for(let elem of document.querySelectorAll(".scrollParallax")){const speed=elem.dataset.scrollspeed||5;elem.setAttribute("style",`transform: translateY(${window.scrollY/speed}px)`)}})),function(){let open=document.querySelector(".call-main"),menu=document.querySelector(".call");open.addEventListener("click",(()=>{menu.classList.toggle("active")}))}();const inputValidate=input=>{if(""!==input.value.trim())return onValid(input),!0;onError(input,"Не указано имя")},emailValidate=email=>{if(""===email.value.trim())onError(email,"Не указана почта");else{if(isValidEmail(email.value.trim()))return onValid(email),!0;onError(email,"Неверно указана почта")}},validate=()=>!(!inputValidate(document.querySelector("#consultation__input-name"))||!emailValidate(document.querySelector("#consultation__input-email")))||(inputValidate(document.querySelector("#consultation__input-name")),emailValidate(document.querySelector("#consultation__input-email")),!1);document.querySelector(".consultation__form-button").addEventListener("click",(e=>{if(e.preventDefault(),!(inputValidate(document.querySelector("#consultation__input-name"))&&emailValidate(document.querySelector("#consultation__input-email"))||(inputValidate(document.querySelector("#consultation__input-name")),emailValidate(document.querySelector("#consultation__input-email")),0)))return;const submit=document.querySelector(".consultation__submit");submit.classList.add("active"),setTimeout((()=>{submit.classList.remove("active");for(let elem of document.querySelectorAll(".consultation__form-element"))elem.value="",elem.classList.remove("valid")}),2e3)}));const onError=(input,text)=>{const id=input.id,message=document.querySelector(`[for="${id}"]`);input.classList.remove("valid"),input.classList.add("error"),message.innerText=text,message.classList.add("active")},onValid=input=>{const id=input.id,message=document.querySelector(`[for="${id}"]`);input.classList.add("valid"),input.classList.remove("error"),message.innerText="",message.classList.remove("active")},isValidEmail=email=>/^[A-Z0-9._%+-]+@[A-Z0-9-]+.+.[A-Z]{2,4}$/i.test(email),submitForm=()=>{};